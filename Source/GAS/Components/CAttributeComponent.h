...
public:
	...
	void NetMulticastHealthChange(AActor* InstigatorActor, float NewHealth, float Delta);

	UFUNCTION(NetMulticast, Reliable)
	void NetMulticastRageChange(AActor* InstigatorActor, float NewRage, float Delta);
